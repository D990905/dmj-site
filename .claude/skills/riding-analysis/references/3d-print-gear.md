...
낭비 없이 동시 7소재, AMS 붙이면 24 필라멘트. 카메라 4대.

**우리가 뽑을 것 중 다소재인 게 하나도 없다.** 케이스는 ASA 단일,
풋스트랩 부품은 ASA/PETG 단일, 패드가 TPU 단일, 하네스 등판이 ASA 단일.
색을 섞을 일도 없다.

그리고 **H2C 가 P2S 보다 나은 두 가지(능동 65°C 챔버 · 3단 HEPA 필터)는
X2D 에 그대로 있고 가격은 1/3 이다.** H2C 에 더 내는 260만원은 전부
다소재 기구에 나가는 돈이다. 핫스왑 핫엔드는 고장날 곳이 늘어나는 것이기도
하다 — TPU 처럼 까다로운 소재에 유리한 요소가 아니다.

빌드볼륨(305×320×325)도 이유가 안 된다. 우리 최대 부품인 하네스 등판이
250×120 이라 X2D 의 256³ 로 충분하다.
